# Phase 191: TUI deepest bucket label visibility profiles

Phase191 upgrades the Phase190 boolean deepest bucket-label control to explicit `shown`, `hidden`, and `adaptive` profiles.
...
- Added `visibility_bucket_labels_labels:shown@(`, `hidden@(`, and adaptive effective indicators.
