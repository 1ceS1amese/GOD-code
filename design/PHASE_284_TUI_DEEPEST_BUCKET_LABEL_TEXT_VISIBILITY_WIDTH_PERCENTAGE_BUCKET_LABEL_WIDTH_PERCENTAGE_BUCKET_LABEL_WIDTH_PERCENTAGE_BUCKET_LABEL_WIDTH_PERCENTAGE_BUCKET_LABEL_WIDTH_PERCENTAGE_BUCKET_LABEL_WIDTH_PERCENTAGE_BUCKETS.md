# Phase284 TUI Deepest Bucket Label Text Visibility Width Percentage Bucket Label Width Percentage Bucket Label Width Percentage Bucket Label Width Percentage Bucket Label Width Percentage Bucket Label Width Percentage Buckets
...
在 Phase283 最新宽度百分比后追加 `L/M/H` 分段。
...
- 119 列输出 `adaptive>hidden+1[119/120=99%H]@0`。
- 120 列输出 `adaptive>shown[120/120=100%H]@0`。
...
- Phase285 已补充 `low/mid/high` 文字标签。
