# Phase 186: TUI innermost bucket label visibility width indicators

Phase186 adds the current content width beside the innermost adaptive bucket-label visibility threshold.

## Implementation status

- Added an innermost width helper using the shared 120-column threshold.
- Changed width-119 output to `visibility_bucket_labels:adaptive>hidden+1[119/120]@&`.
- Changed width-120 output to `visibility_bucket_labels:adaptive>shown[120/120]@&`.
- Preserved the Phase185 `+N` distance below the threshold.
