# Phase 187: TUI innermost bucket label visibility width percentage indicators

Phase187 adds a normalized width percentage to the innermost adaptive bucket-label visibility indicator.

## Implementation status

- Reused the shared width-percentage helper in the innermost width formatter.
- Changed width-119 output to `visibility_bucket_labels:adaptive>hidden+1[119/120=99%]@&`.
- Changed width-120 output to `visibility_bucket_labels:adaptive>shown[120/120=100%]@&`.
